...
// Keep the historical family name so r37 evicts all earlier installation caches safely.
const CACHE_FAMILY=`rce-report-card-${CACHE_SCOPE_KEY}-`;
const CACHE_NAME=`${CACHE_FAMILY}v7-4-0-r37-edusentia-product-ready`;
const STATIC_ASSETS=[
  "./","index.html","style.css","app.js","plan-upgrade-r32.js","edusentia-r37.js","config.js","manifest.webmanifest",
  "assets/school-logo.png","assets/edusentia-logo.png","assets/edusentia-logo-192.png","assets/edusentia-logo-512.png","assets/edusentia-mark.svg",
  "assets/rce-master-logo.png","assets/rce-master-logo-192.png","assets/rce-master-logo-512.png","assets/rce-master-logo-maskable-512.png","assets/favicon-32.png","assets/approved-terminal-report-template.png","assets/approved-terminal-report-template.pdf",
...
self.addEventListener("fetch",event=>{
  ...
  if(url.pathname.endsWith("/plan-upgrade-r32.js")||url.pathname.endsWith("/config.js")||url.pathname.endsWith("/edusentia-r37.js")){
